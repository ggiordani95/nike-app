...
export default function index() {
  ...
  const bottomSheetStyle = useAnimatedStyle<AnimatedStyleProp<any>>(() => {
    return {
  ...
  function closeDrawerBuy() {
    ...
    zIndexBlur.value = -3;
    opacityBlur.value = 0;
    bottomSheetShared.value = withTiming(BOTTOM_SHEET_HEIGHT, {
      duration: 1000,
    });
  }
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: RFValue(14), fontWeight: "500" }}>
                R$ {Math.round(item.price * item.cart_quantity)}
              </Text>
            </View>
            <View
              style={{
      ...
      >
        ...
        >
          ...
          <Text style={{ fontSize: RFValue(18), fontWeight: "500" }}>
            R$ {Math.round(totalPrice)}
          </Text>
        </View>
        <CustomButton
          onPress={openDrawerBuy}
          cart={true}
          widthButton={"100%"}
          href="/cart"
