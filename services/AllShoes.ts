...
export function AllShoesData(isIdSearch: boolean, sneakerId: number): Promise<Array<Object>> {
    return new Promise<Array<Object>>((resolve) => {
            ...
            const shoes: Shoes[] | undefined = [
                ...
                {id: 2256, name: 'LeBron NXXT Gen White/Metallic Silver', image: 'https://imgnike-a.akamaihd.net/768x768/02548751.jpg', desc:'Seja você um saltador do tipo enterrada ou uma maravilha abaixo da cesta vagando pela linha de base, sinta-se mais rápido, mais baixo na quadra e seguro no LeBron NXXT Gen. Nós o adaptamos especificamente para atender às demandas do ritmo acelerado de hoje jogo, para que você possa ficar à frente da oposição com sua velocidade e força em todas as direções.',price: 1119.99,},
